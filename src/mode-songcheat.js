...
ace.define('ace/mode/songcheat_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], function (acequire, exports, module) {
  exports.reservedKeywords = ('%|ARTIST|TITLE|YEAR|DIFFICULTY|VIDEO|TUTORIAL|COMMENT|TUNING|CAPO|KEY|TIME|TEMPO|SHUFFLE|CHORD|BLOCK|STRUCTURE|RHYTHM|PART')
  ...
  var SongcheatHighlightRules = function () {
    ...
    this.$rules = {
      'start': [{
        ...
        { token: 'keyword',
          regex: '^(?:ARTIST|TITLE|YEAR|DIFFICULTY|VIDEO|TUTORIAL|COMMENT|TUNING|CAPO|KEY|TIME|TEMPO|SHUFFLE|CHORD|BLOCK|STRUCTURE|RHYTHM|PART)'
        },
        { token: 'comment',
          regex: '^ *#.*$'
        },
