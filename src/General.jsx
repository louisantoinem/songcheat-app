    ...
    return !this.props.songcheat ? null :
      <div className='General'>
        ...
        {this.props.songcheat.tutorial && <div>
          {ReactPlayer.canPlay(this.props.songcheat.tutorial) && <div className='video-wrapper'><ReactPlayer controls url={this.props.songcheat.tutorial} width='100%' height='100%' /></div>}
        ...
        {this.props.songcheat.source && <div>
          {ReactPlayer.canPlay(this.props.songcheat.source) && <div className='video-wrapper'><ReactPlayer controls url={this.props.songcheat.source} width='100%' height='100%' /></div>}
        ...
        <a className='reset-link' onClick={() => this.props.onResetSettings()}>Reset settings</a>
