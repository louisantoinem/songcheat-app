  ...
  render () {
    ...
    <div className='General'>
      ...
      {this.props.songcheat.video && <div>
        {ReactPlayer.canPlay(this.props.songcheat.video) && <p><ReactPlayer controls url={this.props.songcheat.video} /></p>}
      ...
      <p><b>Signature</b> {this.props.songcheat.signature.time.symbol} {!this.props.songcheat.signature.shuffle ? '' : (this.props.songcheat.signature.shuffle === ':4' ? '/ Shuffled quarter notes' : '/ Shuffled ' + this.props.songcheat.signature.shuffle.substr(1) + 'th notes')}
      ...
      <p><b>Key</b> {this.props.songcheat.signature.key} / <b>Capo</b> {this.props.songcheat.capo > 0 ? this.props.songcheat.capo : '0'} / <b>Tuning</b> {this.props.songcheat.tuning}</p>

      <p><b>Difficulty</b> {this.props.songcheat.difficulty}/5</p>

      {this.props.songcheat.tutorial && <div>
          {ReactPlayer.canPlay(this.props.songcheat.tutorial) && <p><ReactPlayer controls url={this.props.songcheat.tutorial} /></p>}
      ...
      {this.props.songcheat.source && <div>
        {ReactPlayer.canPlay(this.props.songcheat.source) && <p><ReactPlayer controls url={this.props.songcheat.source} /></p>}
